...
<header id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <div class="fill" style="background-image:url('https://unsplash.it/1900/1080?blur');"></div>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <img class="img-responsive" src="http://lorempixel.com/700/450" alt="">
        </div>
    </div>
    <!-- /.row -->
